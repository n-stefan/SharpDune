...
namespace SharpDune
{
	...
	class CExplosion
	{
		...
		static CExplosion()
        {
			unchecked
            {
				...
				s_explosion09 = new ExplosionCommandStruct[] {
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 183 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 41 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 203 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_MOVE_Y_POSITION, parameter = (ushort)-80 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 168 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 169 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 170 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 168 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 169 },
					...
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 170 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
				};

				/* EXPLOSION_SMOKE_PLUME */
				s_explosion15 = new ExplosionCommandStruct[] {
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 183 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 49 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_MOVE_Y_POSITION, parameter = (ushort)-80 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 184 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 180 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 181 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 182 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 181 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
					new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 180 },
		...
		static ExplosionCommandStruct[] s_explosion00 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 153 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 153 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
		...
		static ExplosionCommandStruct[] s_explosion01 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 154 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 153 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
		...
		static ExplosionCommandStruct[] s_explosion02 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 183 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 50 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 184 },
		...
		static ExplosionCommandStruct[] s_explosion04 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 203 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 51 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 204 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 205 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 206 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 207 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion05 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_RANDOM_TIMEOUT, parameter = 60 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 203 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 41 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
		...
		static ExplosionCommandStruct[] s_explosion06 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 198 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 51 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 199 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 200 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 201 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 202 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion07 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 208 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 39 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 209 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 210 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 211 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 212 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion08 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 156 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 40 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 157 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 158 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 157 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
		...
		static ExplosionCommandStruct[] s_explosion10 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 151 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 49 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 152 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion11 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_RANDOM_TIMEOUT, parameter = 60 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 188 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 51 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_TILE_DAMAGE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 7 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 189 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 190 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 191 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 192 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion12 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 213 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 214 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 215 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 216 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 217 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 30 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};

		/* EXPLOSION_SANDWORM_SWALLOW */
		static ExplosionCommandStruct[] s_explosion13 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 218 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 219 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 220 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 221 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 15 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 222 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 30 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_STOP, parameter = 0 }
		};
		...
		static ExplosionCommandStruct[] s_explosion14 = {
			...
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 189 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SCREEN_SHAKE, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 190 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 191 },
		...
		static ExplosionCommandStruct[] s_explosion16 = {
			...
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 49 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_ANIMATION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 204 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 207 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
		...
		static ExplosionCommandStruct[] s_explosion17 = {
			...
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 49 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_ANIMATION, parameter = 4 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 204 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 207 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
		...
		static ExplosionCommandStruct[] s_explosion18 = {
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 183 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_PLAY_VOICE, parameter = 54 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_BLOOM_EXPLOSION, parameter = 0 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_SPRITE, parameter = 184 },
			new ExplosionCommandStruct { command = (byte)ExplosionCommand.EXPLOSION_SET_TIMEOUT, parameter = 3 },
