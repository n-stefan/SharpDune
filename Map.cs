...
namespace SharpDune
{
    ...
    class Map
    {
        ...
        static Map()
        {
            unchecked
            {
                g_table_tilediff = new tile32[][] { //[34][8]
	                new tile32[] { /* 0 */
		                new tile32 { /* 0 */ x = 0, y = 0 },
                        new tile32 { /* 1 */ x = 0, y = (ushort)-1 },
                        new tile32 { /* 2 */ x = 1, y = 0 },
                        new tile32 { /* 3 */ x = 0, y = (ushort)-1 },
                        new tile32 { /* 4 */ x = 1, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 1, y = 0 },
                        new tile32 { /* 7 */ x = 0, y = 0 },
                    },
                    new tile32[] { /* 1 */
		                new tile32 { /* 0 */ x = 0, y = 0 },
                        new tile32 { /* 1 */ x = 0, y = 0 },
                        new tile32 { /* 2 */ x = 0, y = 0 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                        new tile32 { /* 7 */ x = 0, y = 0 },
                    },
                    new tile32[] { /* 2 */
		                new tile32 { /* 0 */ x = 0, y = 16 },
                        new tile32 { /* 1 */ x = 16, y = 0 },
                        new tile32 { /* 2 */ x = 16, y = 16 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 3 */
		                new tile32 { /* 0 */ x = 0, y = 32 },
                        new tile32 { /* 1 */ x = 32, y = 0 },
                        new tile32 { /* 2 */ x = 32, y = 32 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 4 */
		                new tile32 { /* 0 */ x = 0, y = 48 },
                        new tile32 { /* 1 */ x = 48, y = 0 },
                        new tile32 { /* 2 */ x = 48, y = 48 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 5 */
		                new tile32 { /* 0 */ x = 0, y = 64 },
                        new tile32 { /* 1 */ x = 64, y = 0 },
                        new tile32 { /* 2 */ x = 64, y = 64 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 6 */
		                new tile32 { /* 0 */ x = 0, y = 80 },
                        new tile32 { /* 1 */ x = 80, y = 0 },
                        new tile32 { /* 2 */ x = 80, y = 80 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 7 */
		                new tile32 { /* 0 */ x = 0, y = 96 },
                        new tile32 { /* 1 */ x = 96, y = 0 },
                        new tile32 { /* 2 */ x = 96, y = 96 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 8 */
		                new tile32 { /* 0 */ x = 0, y = 112 },
                        new tile32 { /* 1 */ x = 112, y = 0 },
                        new tile32 { /* 2 */ x = 112, y = 112 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 9 */
		                new tile32 { /* 0 */ x = 0, y = 128 },
                        new tile32 { /* 1 */ x = 128, y = 0 },
                        new tile32 { /* 2 */ x = 128, y = 128 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 10 */
		                new tile32 { /* 0 */ x = 0, y = 144 },
                        new tile32 { /* 1 */ x = 144, y = 0 },
                        new tile32 { /* 2 */ x = 144, y = 144 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 11 */
		                new tile32 { /* 0 */ x = 0, y = 160 },
                        new tile32 { /* 1 */ x = 160, y = 0 },
                        new tile32 { /* 2 */ x = 160, y = 160 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 12 */
		                new tile32 { /* 0 */ x = 0, y = 176 },
                        new tile32 { /* 1 */ x = 176, y = 0 },
                        new tile32 { /* 2 */ x = 176, y = 176 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 13 */
		                new tile32 { /* 0 */ x = 0, y = 192 },
                        new tile32 { /* 1 */ x = 192, y = 0 },
                        new tile32 { /* 2 */ x = 192, y = 192 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 14 */
		                new tile32 { /* 0 */ x = 0, y = 208 },
                        new tile32 { /* 1 */ x = 208, y = 0 },
                        new tile32 { /* 2 */ x = 208, y = 208 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 15 */
		                new tile32 { /* 0 */ x = 0, y = 224 },
                        new tile32 { /* 1 */ x = 224, y = 0 },
                        new tile32 { /* 2 */ x = 224, y = 224 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 16 */
		                new tile32 { /* 0 */ x = 0, y = 240 },
                        new tile32 { /* 1 */ x = 240, y = 0 },
                        new tile32 { /* 2 */ x = 240, y = 240 },
                        new tile32 { /* 3 */ x = 0, y = 0 },
                        new tile32 { /* 4 */ x = 0, y = 0 },
                        new tile32 { /* 5 */ x = 0, y = 0 },
                        new tile32 { /* 6 */ x = 0, y = 0 },
                    ...
                    new tile32[] { /* 17 */
		                new tile32 { /* 0 */ x = 0, y = 256 },
                        new tile32 { /* 1 */ x = 256, y = 0 },
                        new tile32 { /* 2 */ x = 256, y = 256 },
                        new tile32 { /* 3 */ x = 128, y = 0 },
                        new tile32 { /* 4 */ x = 128, y = 256 },
                        new tile32 { /* 5 */ x = 0, y = 128 },
                        new tile32 { /* 6 */ x = 256, y = 128 },
                        new tile32 { /* 7 */ x = 128, y = 128 },
                    },
                    new tile32[] { /* 18 */
		                new tile32 { /* 0 */ x = 0, y = 272 },
                        new tile32 { /* 1 */ x = 272, y = 0 },
                        new tile32 { /* 2 */ x = 272, y = 272 },
                        new tile32 { /* 3 */ x = 128, y = 0 },
                        new tile32 { /* 4 */ x = 128, y = 272 },
                        new tile32 { /* 5 */ x = 0, y = 128 },
                        new tile32 { /* 6 */ x = 272, y = 128 },
                        new tile32 { /* 7 */ x = 128, y = 128 },
                    },
                    new tile32[] { /* 19 */
		                new tile32 { /* 0 */ x = 0, y = 288 },
                        new tile32 { /* 1 */ x = 288, y = 0 },
                        new tile32 { /* 2 */ x = 288, y = 288 },
                        new tile32 { /* 3 */ x = 144, y = 0 },
                        new tile32 { /* 4 */ x = 144, y = 288 },
                        new tile32 { /* 5 */ x = 0, y = 144 },
                        new tile32 { /* 6 */ x = 288, y = 144 },
                        new tile32 { /* 7 */ x = 144, y = 144 },
                    },
                    new tile32[] { /* 20 */
		                new tile32 { /* 0 */ x = 0, y = 304 },
                        new tile32 { /* 1 */ x = 304, y = 0 },
                        new tile32 { /* 2 */ x = 304, y = 304 },
                        new tile32 { /* 3 */ x = 144, y = 0 },
                        new tile32 { /* 4 */ x = 144, y = 304 },
                        new tile32 { /* 5 */ x = 0, y = 144 },
                        new tile32 { /* 6 */ x = 304, y = 144 },
                        new tile32 { /* 7 */ x = 144, y = 144 },
                    },
                    new tile32[] { /* 21 */
		                new tile32 { /* 0 */ x = 0, y = 320 },
                        new tile32 { /* 1 */ x = 320, y = 0 },
                        new tile32 { /* 2 */ x = 320, y = 320 },
                        new tile32 { /* 3 */ x = 160, y = 0 },
                        new tile32 { /* 4 */ x = 160, y = 320 },
                        new tile32 { /* 5 */ x = 0, y = 160 },
                        new tile32 { /* 6 */ x = 320, y = 160 },
                        new tile32 { /* 7 */ x = 160, y = 160 },
                    },
                    new tile32[] { /* 22 */
		                new tile32 { /* 0 */ x = 0, y = 336 },
                        new tile32 { /* 1 */ x = 336, y = 0 },
                        new tile32 { /* 2 */ x = 336, y = 336 },
                        new tile32 { /* 3 */ x = 160, y = 0 },
                        new tile32 { /* 4 */ x = 160, y = 336 },
                        new tile32 { /* 5 */ x = 0, y = 160 },
                        new tile32 { /* 6 */ x = 336, y = 160 },
                        new tile32 { /* 7 */ x = 160, y = 160 },
                    },
                    new tile32[] { /* 23 */
		                new tile32 { /* 0 */ x = 0, y = 352 },
                        new tile32 { /* 1 */ x = 352, y = 0 },
                        new tile32 { /* 2 */ x = 352, y = 352 },
                        new tile32 { /* 3 */ x = 176, y = 0 },
                        new tile32 { /* 4 */ x = 176, y = 352 },
                        new tile32 { /* 5 */ x = 0, y = 176 },
                        new tile32 { /* 6 */ x = 352, y = 176 },
                        new tile32 { /* 7 */ x = 176, y = 176 },
                    },
                    new tile32[] { /* 24 */
		                new tile32 { /* 0 */ x = 0, y = 368 },
                        new tile32 { /* 1 */ x = 368, y = 0 },
                        new tile32 { /* 2 */ x = 368, y = 368 },
                        new tile32 { /* 3 */ x = 176, y = 0 },
                        new tile32 { /* 4 */ x = 176, y = 368 },
                        new tile32 { /* 5 */ x = 0, y = 176 },
                        new tile32 { /* 6 */ x = 368, y = 176 },
                        new tile32 { /* 7 */ x = 176, y = 176 },
                    },
                    new tile32[] { /* 25 */
		                new tile32 { /* 0 */ x = 0, y = 384 },
                        new tile32 { /* 1 */ x = 384, y = 0 },
                        new tile32 { /* 2 */ x = 384, y = 384 },
                        new tile32 { /* 3 */ x = 192, y = 0 },
                        new tile32 { /* 4 */ x = 192, y = 384 },
                        new tile32 { /* 5 */ x = 0, y = 192 },
                        new tile32 { /* 6 */ x = 384, y = 192 },
                        new tile32 { /* 7 */ x = 192, y = 192 },
                    },
                    new tile32[] { /* 26 */
		                new tile32 { /* 0 */ x = 0, y = 400 },
                        new tile32 { /* 1 */ x = 400, y = 0 },
                        new tile32 { /* 2 */ x = 400, y = 400 },
                        new tile32 { /* 3 */ x = 192, y = 0 },
                        new tile32 { /* 4 */ x = 192, y = 400 },
                        new tile32 { /* 5 */ x = 0, y = 192 },
                        new tile32 { /* 6 */ x = 400, y = 192 },
                        new tile32 { /* 7 */ x = 192, y = 192 },
                    },
                    new tile32[] { /* 27 */
		                new tile32 { /* 0 */ x = 0, y = 416 },
                        new tile32 { /* 1 */ x = 416, y = 0 },
                        new tile32 { /* 2 */ x = 416, y = 416 },
                        new tile32 { /* 3 */ x = 208, y = 0 },
                        new tile32 { /* 4 */ x = 208, y = 416 },
                        new tile32 { /* 5 */ x = 0, y = 208 },
                        new tile32 { /* 6 */ x = 416, y = 208 },
                        new tile32 { /* 7 */ x = 208, y = 208 },
                    },
                    new tile32[] { /* 28 */
		                new tile32 { /* 0 */ x = 0, y = 432 },
                        new tile32 { /* 1 */ x = 432, y = 0 },
                        new tile32 { /* 2 */ x = 432, y = 432 },
                        new tile32 { /* 3 */ x = 208, y = 0 },
                        new tile32 { /* 4 */ x = 208, y = 432 },
                        new tile32 { /* 5 */ x = 0, y = 208 },
                        new tile32 { /* 6 */ x = 432, y = 208 },
                        new tile32 { /* 7 */ x = 208, y = 208 },
                    },
                    new tile32[] { /* 29 */
		                new tile32 { /* 0 */ x = 0, y = 448 },
                        new tile32 { /* 1 */ x = 448, y = 0 },
                        new tile32 { /* 2 */ x = 448, y = 448 },
                        new tile32 { /* 3 */ x = 224, y = 0 },
                        new tile32 { /* 4 */ x = 224, y = 448 },
                        new tile32 { /* 5 */ x = 0, y = 224 },
                        new tile32 { /* 6 */ x = 448, y = 224 },
                        new tile32 { /* 7 */ x = 224, y = 224 },
                    },
                    new tile32[] { /* 30 */
		                new tile32 { /* 0 */ x = 0, y = 464 },
                        new tile32 { /* 1 */ x = 464, y = 0 },
                        new tile32 { /* 2 */ x = 464, y = 464 },
                        new tile32 { /* 3 */ x = 224, y = 0 },
                        new tile32 { /* 4 */ x = 224, y = 464 },
                        new tile32 { /* 5 */ x = 0, y = 224 },
                        new tile32 { /* 6 */ x = 464, y = 224 },
                        new tile32 { /* 7 */ x = 224, y = 224 },
                    },
                    new tile32[] { /* 31 */
		                new tile32 { /* 0 */ x = 0, y = 480 },
                        new tile32 { /* 1 */ x = 480, y = 0 },
                        new tile32 { /* 2 */ x = 480, y = 480 },
                        new tile32 { /* 3 */ x = 240, y = 0 },
                        new tile32 { /* 4 */ x = 240, y = 480 },
                        new tile32 { /* 5 */ x = 0, y = 240 },
                        new tile32 { /* 6 */ x = 480, y = 240 },
                        new tile32 { /* 7 */ x = 240, y = 240 },
                    },
                    new tile32[] { /* 32 */
		                new tile32 { /* 0 */ x = 0, y = 496 },
                        new tile32 { /* 1 */ x = 496, y = 0 },
                        new tile32 { /* 2 */ x = 496, y = 496 },
                        new tile32 { /* 3 */ x = 240, y = 0 },
                        new tile32 { /* 4 */ x = 240, y = 496 },
                        new tile32 { /* 5 */ x = 0, y = 240 },
                        new tile32 { /* 6 */ x = 496, y = 240 },
                        new tile32 { /* 7 */ x = 240, y = 240 },
                    },
                    new tile32[] { /* 33 */
		                new tile32 { /* 0 */ x = 0, y = 768 },
                        new tile32 { /* 1 */ x = 768, y = 0 },
                        new tile32 { /* 2 */ x = 768, y = 768 },
                        new tile32 { /* 3 */ x = 512, y = 0 },
                        new tile32 { /* 4 */ x = 512, y = 512 },
                        new tile32 { /* 5 */ x = 0, y = 512 },
                        new tile32 { /* 6 */ x = 512, y = 256 },
                        new tile32 { /* 7 */ x = 256, y = 256 },
                    }
                };
            }
        }
        ...
        internal static MapInfo[] g_mapInfos = { //[3]
	        new MapInfo { minX =  1, minY =  1, sizeX = 62, sizeY = 62 },
	        new MapInfo { minX = 16, minY = 16, sizeX = 32, sizeY = 32 },
	        new MapInfo { minX = 21, minY = 21, sizeX = 21, sizeY = 21 }
        };
        ...
        internal static void Map_UpdateAround(ushort radius, tile32 position, Unit unit, byte function)
        {
            ...
            do
            {
                tile32 curTile = CTile.Tile_AddTileDiff(position, diff);

                if (CTile.Tile_IsValid(curTile))
                {
                    ushort curPacked = CTile.Tile_PackTile(curTile);
        ...
        static void Map_UnveilTile_Neighbour(ushort packed)
        {
            ...
            if (t.isUnveiled)
            {
                ...
                for (i = 0; i < 4; i++)
                {
                    ushort neighbour = (ushort)(packed + g_table_mapDiff[i]);
            ...
            if (tileID != 0)
            {
                if (tileID != 15)
                {
                    Unit u = CUnit.Unit_Get_ByPackedTile(packed);
        ...
        static void Map_FixupSpiceEdges(ushort packed)
        {
            ...
            if (type == (ushort)LandscapeType.LST_SPICE || type == (ushort)LandscapeType.LST_THICK_SPICE)
            {
                ...
                for (i = 0; i < 4; i++)
                {
                    ushort curPacked = (ushort)(packed + g_table_mapDiff[i]);
                    ushort curType;
        ...
        {
            ushort reactionDistance = (ushort)((type == (ushort)ExplosionType.EXPLOSION_DEATH_HAND) ? 32 : 16);
            ushort positionPacked = CTile.Tile_PackTile(position);
            ...
            if (!s_debugNoExplosionDamage && hitpoints != 0)
            {
                ...
                while (true)
                {
                    ...
                    {
                        UnitInfo uis = CUnit.g_table_unitInfo[us.o.type];
                    ...
                    if (attack != null)
                    {
                        ushort packed = CTile.Tile_PackTile(u.o.position);
            ...
            if (!s_debugNoExplosionDamage && hitpoints != 0)
            {
                Structure s = CStructure.Structure_Get_ByPackedTile(positionPacked);

                if (s != null)
                {
                    if (type == (ushort)ExplosionType.EXPLOSION_IMPACT_LARGE)
                    {
                        StructureInfo si = CStructure.g_table_structureInfo[s.o.type];
        ...
        internal static void Map_FillCircleWithSpice(ushort packed, ushort radius)
        {
            ...
            for (i = -radius; i <= radius; i++)
            {
                ...
                {
                    ushort curPacked = CTile.Tile_PackXY((ushort)(x + j), (ushort)(y + i));
                    ushort distance = CTile.Tile_GetDistancePacked(packed, curPacked);
        ...
        */
        internal static ushort Map_MoveDirection(ushort direction)
        {
            unchecked
            {
                mapScrollOffset = new XYPosition[] {
                    new XYPosition { x = 0, y = (ushort)-1 }, new XYPosition { x = 1, y = (ushort)-1 }, new XYPosition { x = 1, y = 0 }, new XYPosition { x = 1, y = 1 },
                    new XYPosition { x = 0, y = 1 }, new XYPosition { x = (ushort)-1, y = 1 }, new XYPosition { x = (ushort)-1, y = 0 }, new XYPosition { x = (ushort)-1, y = (ushort)-1 }
                };
            }
        ...
        {
            MapInfo mapInfo = g_mapInfos[CScenario.g_scenario.mapScale];
            ushort mapOffset = (ushort)mapBase[CScenario.g_scenario.mapScale];
        ...
        internal static ushort Map_SearchSpice(ushort packed, ushort radius)
        {
            ...
            for (y = ymin; y <= ymax; y++)
            {
                for (x = xmin; x <= xmax; x++)
                {
                    ushort curPacked = CTile.Tile_PackXY(x, y);
                    ushort type;
                    ushort distance;
        ...
        internal static void Map_Bloom_ExplodeSpecial(ushort packed, byte houseID)
        {
            ...
            switch (Tools.Tools_Random_256() & 0x3)
            {
                ...
                case 1:
                    {
                        tile32 position = CTile.Tile_UnpackTile(packed);
        ...
        */
        ...
        internal static void Map_CreateLandscape(uint seed)
        {
            ...
            ushort[] currentRow = new ushort[64];
            ushort[] previousRow = new ushort[64];
            ushort spriteID1;
            ushort spriteID2;
            ushort[] iconMap;
            ...
            while (i-- != 0)
            {
                ...
                {
                    short index = (short)Min(Max(0, baseline + around[j]), 272);
            ...
            for (j = 0; j < 16; j++)
            {
                for (i = 0; i < 16; i++)
                {
                    for (k = 0; k < 21; k++)
                    {
                        ushort[] offsets = _offsetTable[(i + 1) % 2][k];
                        ushort packed1;
                        ushort packed2;
                        ushort packed;
                        ushort sprite2;
            ...
            for (j = 0; j < 64; j++)
            {
                ...
                for (i = 0; i < 64; i++)
                {
                    ushort[] neighbours = new ushort[9];
                    ushort total = 0;
            ...
            for (i = 0; i < 4096; i++)
            {
                ushort spriteID = g_map[i].groundTileID;
            ...
            for (j = 0; j < 64; j++)
            {
                ...
                for (i = 0; i < 64; i++)
                {
                    ushort current = t[i].groundTileID;
                    ushort up = (j == 0) ? current : previousRow[i];
                    ushort right = (i == 63) ? current : currentRow[i + 1];
                    ushort down = (j == 63) ? current : t[i + 64].groundTileID;
                    ushort left = (i == 0) ? current : currentRow[i - 1];
                    ushort spriteID = 0;
                ...
                case LandscapeType.LST_THICK_SPICE:
                    {
                        ...
                        for (j = -1; j <= 1; j++)
                        {
                            ...
                            {
                                Tile t2;
                                ushort packed2 = CTile.Tile_PackXY((ushort)(CTile.Tile_GetPackedX(packed) + i), (ushort)(CTile.Tile_GetPackedY(packed) + j));
